...
OPEN "I", #1, "/data/data/cz.jh.suite/files/Brown3/JH-Brown3.inp"
INPUT #1, A$, B$, C$, D$, E$, F$, G$, H$, I$, J$, K$, L$, M$
CLOSE #1
OPEN "O", #2, "/data/data/cz.jh.suite/files/Brown3/JH-Brown3.out"
...
ExistInput = EXIST("/data/data/cz.jh.suite/files/Brown3/JH-Brown3.inp")
...
PRINT "================================================================================"
PRINT "Execution of JH-Brown3.b terminated ABNORMALLY, "; DATE$; ", "; TIME$; "."
OPEN "A", #2, "/data/data/cz.jh.suite/files/Brown3/JH-Brown3.out"
...
IF E$ <> "OH-" THEN
PRINT "This type of calculation is currently supported only for OH-."
PRINT "================================================================================"
PRINT "REFERENCES:"
PRINT "[1] Paul Leslie Brown, Ronald N. Sylva, AAEC/E656 1987 (patent)."
PRINT "[2] Paul Leslie Brown, Ronald N. Sylva, J. Chem. Soc., Dalton Trans. 4 (1985)"
...
PRINT "Execution of JH-Brown3.b terminated ABNORMALLY, "; DATE$; ", "; TIME$; "."
OPEN "A", #2, "/data/data/cz.jh.suite/files/Brown3/JH-Brown3.out"
PRINT #2, "This type of calculation is currently supported only for OH-."
GOTO Error
ENDIF
...
DIM StockarText$(200)
OPEN "I", #5, "/data/data/cz.jh.suite/files/Brown3/JH-Radii_Stockar.dat"
FOR K% = 0 TO 199
...
DIM ShannonText$(500)
OPEN "I", #6, "/data/data/cz.jh.suite/files/Brown3/JH-Radii_Shannon.dat"
FOR L% = 0 TO 499
...
DIM ShannonText$(500)
OPEN "I", #6, "/data/data/cz.jh.suite/files/Brown3/Radii_Shannon.dat"
FOR L% = 0 TO 499
INPUT #6, ShannonRadii$
ShannonText$(L%) = ShannonRadii$
LengthShannon = LEN(ShannonRadii$)
...
DIM KlopmanText$(200)
OPEN "I", #12, "/data/data/cz.jh.suite/files/Brown3/JH-Klopman.dat"
FOR P% = 0 TO 199
...
IF p * zM + q * zL <> 0 THEN
PRINT "The charge balance is not satisfied. Please check the input formula."
PRINT "================================================================================"
PRINT "REFERENCES:"
PRINT "[1] Paul Leslie Brown, Ronald N. Sylva, AAEC/E656 1987 (patent)."
PRINT "[2] Paul Leslie Brown, Ronald N. Sylva, J. Chem. Soc., Dalton Trans. 4 (1985)"
...
PRINT "Execution of JH-Brown3.b terminated ABNORMALLY, "; DATE$; ", "; TIME$; "."
OPEN "A", #2, "/data/data/cz.jh.suite/files/Brown3/JH-Brown3.out"
PRINT #2, "The charge balance is not satisfied. Please check the input formula."
GOTO Error
ENDIF
...
OPEN "I", #3, "/data/data/cz.jh.suite/files/Brown3/JH-Acids_Brown3.dat"
...
OPEN "I", #10, "/data/data/cz.jh.suite/files/Brown3/JH-Parr.par"
INPUT #10, Parrpar$
...
DIM ParrText$(200)
OPEN "I", #8, "/data/data/cz.jh.suite/files/Brown3/JH-Acids_Parr.dat"
FOR M% = 0 TO 199
INPUT #8, AcidsParr$
...
OPEN "I", #11, "/data/data/cz.jh.suite/files/Brown3/JH-Klopman.par"
INPUT #11, Klopmanpar$
...
DIM KlopmanText$(200)
OPEN "I", #11, "/data/data/cz.jh.suite/files/Brown3/JH-AtomData_Brown3.dat"
FOR O% = 0 TO 199
...
OPEN "I", #4, "/data/data/cz.jh.suite/files/Brown3/JH-Bases_Brown3.dat"
...
DIM ParrText2$(200)
OPEN "I", #9, "/data/data/cz.jh.suite/files/Brown3/JH-Bases_Parr.dat"
FOR N% = 0 TO 199
INPUT #9, BasesParr$
...
OPEN "I", #7, "/data/data/cz.jh.suite/files/Brown3/JH-Brown3.par"
INPUT #7, Brown1par$
...
log_Ksp = 14.46 * zM - 3.6 * Aqua - 5.5 - (0.14 * zM + 0.018 * (1-4*Aqua)) * (g1 * (zM / (rM^2) + g2))
...
ELSE IF q-2*Aqua > 0 THEN

PRINT #2, "O";
IF q-Aqua-(q-2*Aqua) > 1 THEN
PRINT #2, q-Aqua-(q-2*Aqua);
ENDIF
PRINT #2, "(";
PRINT #2, Element1$;
PRINT #2, ")";
...
PRINT #2, "================================================================================"
PRINT #2, "Execution of JH-Brown3.b terminated NORMALLY, "; DATE$; "; "; TIME$; "."
CLOSE #2
EXIT
END
...
PRINT #2, "(Interpreter & Compiler)"
PRINT #2, "================================================================================"
PRINT #2, "Execution of JH-Brown3.b terminated ABNORMALLY, "; DATE$; "; "; TIME$; "."
CLOSE #2
