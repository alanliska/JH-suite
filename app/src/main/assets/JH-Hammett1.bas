...
OPEN "I", #4, "/data/data/cz.jh.suite/files/Hammett1/JH-Hammett1.inp"
INPUT #4, Parameters$
...
Acid$ = MID$(Parameters$, 1, DelimPar1%-1)
...
PRINT "RESULTS"
PRINT "================================================================================"
PRINT "No input file. Please, write the input in JH-Hammett1.inp and start the program"
PRINT "again. The results will appear in JH-Hammett1.out."
PRINT "================================================================================"
PRINT "REFERENCES:"
...
PRINT "================================================================================"
PRINT "Execution of JH-Hammett1.b terminated ABNORMALLY, "; DATE$; ", "; TIME$; "."
OPEN "A", #2, "/data/data/cz.jh.suite/files/Hammett1/JH-Hammett1.out"
PRINT #2, "================================================================================"
PRINT #2, "RESULTS"
PRINT #2, "================================================================================"
PRINT #2, "No input file. Please, write the input in JH-Hammett1.inp and start the program again."
PRINT #2, "The results will appear in JH-Hammett1.out."
PRINT #2, "================================================================================"
PRINT #2, "REFERENCES:"
...
PRINT #2, "================================================================================"
PRINT #2, "Execution of JH-Hammett1.b terminated ABNORMALLY, "; DATE$; ", "; TIME$; "."
CLOSE #2
EXIT
ENDIF

OPEN "I", #1, "/data/data/cz.jh.suite/files/Hammett1/JH-Hammett1-Rho.dat"
I% = 0
...
HA$ = MID$(Item$, 1, Delim1%-1)
A$ = MID$(Item$, Delim1%+1, Delim2%-Delim1%-1)
Medium$ = MID$(Item$, Delim2%+1, Delim3%-Delim2%-1)
Temperature$ = MID$(Item$, Delim3%+1, Delim4%-Delim3%-1)
Rho$ = MID$(Item$, Delim4%+1, Delim5%-Delim4%-1)
SigmaType$ = MID$(Item$, Delim5%+1, Delim6%-Delim5%-1)
pKa$ = MID$(Item$, Delim6%+1, Length%-Delim6%)

Temperature = VAL(Temperature$)
Rho = VAL(Rho$)
pKa = VAL(pKa$)

IF Acid$ = HA$ AND Medium$ = Med$ THEN
Rho_val = Rho
pKa0 = pKa
SType$ = SigmaType$
ENDIF
...
OPEN "I", #3, "/data/data/cz.jh.suite/files/Hammett1/JH-Hammett1-Sigma.dat"
...
pKa_new = pKa0 + Rho_val * (Sigma_m1+Sigma_m2+Sigma_p) 
Diff = pKa_new-pKa0
...
PRINT #2, "RESULTS"
PRINT #2, "================================================================================"
PRINT #2, "pKa(subst.)-pKa(parental) = "; Diff USING "##.##"
PRINT #2, "================================================================================"
PRINT #2, "REFERENCES:"
PRINT #2, "[1] Otto Exner: Korelacni vztahy v organicke chemii. SNTL/Alfa, Praha 1981."
PRINT #2, "[2] N. B. Chapman, J. Shorter: Correlation Analysis in Chemistry, Recent"
...
PRINT #2, "(Interpreter & Compiler)"
PRINT #2, "================================================================================"
PRINT #2, "Execution of JH-Hammett1.b terminated NORMALLY, "; DATE$; ", "; TIME$; "."
CLOSE #2
EXIT
END
