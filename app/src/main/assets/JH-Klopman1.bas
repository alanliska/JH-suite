...
OPEN "I", #1, "/data/data/cz.jh.suite/files/Klopman1/JH-Klopman1.dat"

OPEN "O", #2, "/data/data/cz.jh.suite/files/Klopman1/JH-Klopman1.out"
PRINT #2, "============================ * JH PROGRAM SUITE * =============================="
PRINT #2, "================= * Procedure Klopman I (organic compounds) * =================="
PRINT #2, "Version 1.00 for Android"
#PRINT #2, "Compiled 2022-08-16 using X11-BASIC"
PRINT #2, "(C) Alan Liska & Veronika Ruzickova, 2022"
CLOSE #2

ExistInput = EXIST("/data/data/cz.jh.suite/files/Klopman1/JH-Klopman1.inp")
IF ExistInput <> -1 THEN
PRINT "============================ * JH PROGRAM SUITE * =============================="
PRINT "================= * Procedure Klopman I (organic compounds) * =================="
...
PRINT "RESULTS"
PRINT "================================================================================"
PRINT "No input file. Please, write the input in JH-Klopman1.inp and start the"
PRINT "program again. The results will appear in JH-Klopman1.out."
PRINT "================================================================================"
PRINT "REFERENCES:"
...
PRINT "================================================================================"
PRINT "Execution of JH-Klopman1.b terminated ABNORMALLY, "; DATE$; ", "; TIME$; "."
OPEN "A", #2, "/data/data/cz.jh.suite/files/Klopman1/JH-Klopman1.out"
PRINT #2, "================================================================================"
PRINT #2, "RESULTS"
PRINT #2, "================================================================================"
PRINT #2, "No input file. Please, write the input in JH-Klopman1.inp and start the"
PRINT #2, "program again. The results will appear in JH-Klopman1.out."
PRINT #2, "================================================================================"
PRINT #2, "REFERENCES:"
...
PRINT #2, "================================================================================"
PRINT #2, "Execution of JH-Klopman1.b terminated ABNORMALLY, "; DATE$; ", "; TIME$; "."
CLOSE #2
EXIT
ENDIF
...
OPEN "I", #3, "/data/data/cz.jh.suite/files/Klopman1/JH-Klopman1.inp"
...
PRINT #2, "(Interpreter & Compiler)"
PRINT #2, "================================================================================"
PRINT #2, "Execution of JH-Klopman1.b terminated NORMALLY, "; DATE$; ", "; TIME$; "."
CLOSE #2
EXIT
END
