...
OPEN "I", #1, "/data/data/cz.jh.suite/files/Misono2/JH-Misono2.inp"
INPUT #1, A$, B$
CLOSE #1

OPEN "O", #2, "/data/data/cz.jh.suite/files/Misono2/JH-Misono2.out"
PRINT #2, "=========================== * JH PROGRAM SUITE * ==============================="
PRINT #2, "========================= * Procedure MISONO II * =============================="
...
ExistInput = EXIST("/data/data/cz.jh.suite/files/Misono2/JH-Misono2.inp")
IF ExistInput <> -1 THEN
PRINT "Missing the input file."
PRINT "================================================================================"
PRINT "REFERENCES:"
PRINT "[1] Makoto Misono, Yasukazu Saito, Bulletin of The Chemical Society of Japan 43"
PRINT " (1970) 3680-3684."
PRINT "[2] Makoto Misono, Ei´ichiro Ochiai, Yasukazu Saito, Yukio Yoneda, J. Inorg."
PRINT " Nucl. Chem. 29 (1967) 2685-2691."
PRINT "[3] Walter Gordy, WJ Orville Thomas, The Journal of Chemical Physics 24(2)"
PRINT " (1956) 439-444."
PRINT "[4] Klaus Stockar, Helvetica Chimica Acta 33(6) (1950) 1409-1420."
PRINT "ACKNOWLEDGEMENTS"
PRINT "Markus Hoffmann: X11-BASIC, Version 1.28, 1997-2022, x11-basic.sourceforge.net"
PRINT "(Interpreter & Compiler)"
PRINT "================================================================================"
PRINT "Execution of JH-Misono2.b terminated ABNORMALLY, "; DATE$; ", "; TIME$; "."
OPEN "A", #2, "/data/data/cz.jh.suite/files/Misono2/JH-Misono2.out"
...
DIM StockarText$(200)
OPEN "I", #3, "/data/data/cz.jh.suite/files/Misono2/JH-Radii_Stockar.dat"
FOR K% = 0 TO 199
...
DIM IText$(200)
OPEN "I", #4, "/data/data/cz.jh.suite/files/Misono2/JH-AtomData_Misono2.dat"
FOR O% = 0 TO 199
INPUT #4, IBlock$
IText$(O%) = IBlock$
LengthI = LEN(IBlock$)
...
DIM Electroneg$(500)
OPEN "I", #5, "/data/data/cz.jh.suite/files/Misono2/JH-Electronegativity_Misono2.dat"
FOR L% = 0 TO 499
...
DIM Parms$(500)
OPEN "I", #6, "/data/data/cz.jh.suite/files/Misono2/JH-Misono2.dat"
FOR L% = 0 TO 499
INPUT #6, ParmText$
Parms$(L%) = ParmText$
...
PRINT #2, "================================================================================"
PRINT #2, "REFERENCES:"
PRINT #2, "[1] Makoto Misono, Yasukazu Saito, Bulletin of The Chemical Society of Japan 43"
PRINT #2, " (1970) 3680-3684."
PRINT #2, "[2] Makoto Misono, Ei´ichiro Ochiai, Yasukazu Saito, Yukio Yoneda, J. Inorg."
PRINT #2, " Nucl. Chem. 29 (1967) 2685-2691."
PRINT #2, "[3] Walter Gordy, WJ Orville Thomas, The Journal of Chemical Physics 24(2)"
PRINT #2, " (1956) 439-444."
PRINT #2, "[4] Klaus Stockar, Helvetica Chimica Acta 33(6) (1950) 1409-1420."
...
PRINT #2, "================================================================================"
PRINT #2, "Execution of JH-Misono2.b terminated NORMALLY, "; DATE$; "; "; TIME$; "."
CLOSE #2
EXIT
END
...
PRINT #2, "(Interpreter & Compiler)"
PRINT #2, "================================================================================"
PRINT #2, "Execution of JH-Misono2.b terminated ABNORMALLY, "; DATE$; "; "; TIME$; "."
CLOSE #2
QUIT
END
