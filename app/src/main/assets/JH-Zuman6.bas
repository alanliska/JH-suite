...
OPEN "I", #1, "/data/data/cz.jh.suite/files/Zuman6/JH-Zuman6-Rho.dat"

OPEN "O", #2, "/data/data/cz.jh.suite/files/Zuman6/JH-Zuman6.out"
PRINT #2, "============================ * JH PROGRAM SUITE * =============================="
PRINT #2, "=========================== * Procedure ZUMAN VI * ============================="
PRINT #2, "Version 1.00 for Android"
#PRINT #2, "Compiled 2018-08-15 using X11-BASIC"
PRINT #2, "(C) Alan Liska & Veronika Ruzickova, 2022"
CLOSE #2

ExistInput = EXIST("/data/data/cz.jh.suite/files/Zuman6/JH-Zuman6.inp")
IF ExistInput <> -1 THEN
PRINT "============================ * JH PROGRAM SUITE * =============================="
PRINT "=========================== * Procedure ZUMAN VI * ============================="
PRINT "Version 1.00 for Android"
#PRINT "Compiled 2018-08-15 using X11-BASIC"
PRINT "(C) Alan Liska & Veronika Ruzickova, 2022"
PRINT "================================================================================"
PRINT "RESULTS"
PRINT "================================================================================"
PRINT "No input file. Please, write the input in JH-Zuman6.inp and start the program"
PRINT "again. The results will appear in JH-Zuman6.out."
PRINT "================================================================================"
PRINT "REFERENCES:"
...
PRINT "================================================================================"
PRINT "Execution of JH-Zuman6.b terminated ABNORMALLY, "; DATE$; ", "; TIME$; "."
OPEN "A", #2, "/data/data/cz.jh.suite/files/Zuman6/JH-Zuman6.out"
PRINT #2, "================================================================================"
PRINT #2, "RESULTS"
PRINT #2, "================================================================================"
PRINT #2, "No input file. Please, write the input in JH-Zuman6.inp and start the program again."
PRINT #2, "The results will appear in JH-Zuman6.out."
PRINT #2, "================================================================================"
PRINT #2, "REFERENCES:"
...
PRINT #2, "================================================================================"
PRINT #2, "Execution of JH-Zuman6.b terminated ABNORMALLY, "; DATE$; ", "; TIME$; "."
CLOSE #2
EXIT
ENDIF
...
OPEN "I", #4, "/data/data/cz.jh.suite/files/Zuman6/JH-Zuman6.inp"
INPUT #4, Parameters$
...
OPEN "I", #3, "/data/data/cz.jh.suite/files/Zuman6/JH-Zuman6-Sigma.dat"
...
PRINT #2, ""
PRINT #2, "Solvents: DMF=N,N-dimethylformamide"
PRINT #2, "Mechanism: SN1=monomolecular nucleophilic substitution, S2=bimolecular"
PRINT #2, "nucleophilic substitution"
...
PRINT #2, "(Interpreter & Compiler)"
PRINT #2, "================================================================================"
PRINT #2, "Execution of JH-Zuman6.b terminated NORMALLY, "; DATE$; ", "; TIME$; "."
CLOSE #2
EXIT
END
