...
public class BanksBurnop extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.banksburnop);
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BanksBurnop.this, ParmsBanksBurnop.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BanksBurnop.this, CodeBanksBurnop.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(BanksBurnop.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(BanksBurnop.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Banks-Burnop")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Banks-Burnop");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(BanksBurnop.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.b "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.b");
                    exec("chmod 755 "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.out"));
                        InputField(exec("cat "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(BanksBurnop.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(BanksBurnop.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Banks-Burnop")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Banks-Burnop");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.out"));
                    InputField(exec("cat "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(BanksBurnop.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
