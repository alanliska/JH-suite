...
public class BaylessRicci extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.baylessricci);
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BaylessRicci.this, ParmsBaylessRicci.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BaylessRicci.this, CodeBaylessRicci.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(BaylessRicci.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(BaylessRicci.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Bayless-Ricci")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Bayless-Ricci");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(BaylessRicci.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.b "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.b");
                    exec("chmod 755 "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.out"));
                        InputField(exec("cat "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(BaylessRicci.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(BaylessRicci.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Bayless-Ricci")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Bayless-Ricci");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.out"));
                    InputField(exec("cat "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(BaylessRicci.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
