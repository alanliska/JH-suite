...
public class Bell extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Bell.this, ParmsBell.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Bell.this, CodeBell.class);
                startActivity(intent);
            }
        });
    }
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Bell/JH-Bell.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Bell/JH-Bell.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Bell.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Bell.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Bell")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Bell");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Bell.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Bell/JH-Bell.b "+getFilesDir()+"/Bell/JH-Bell.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Bell/JH-Bell.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Bell/JH-Bell.b");
                    exec("chmod 755 "+getFilesDir()+"/Bell/JH-Bell.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Bell/JH-Bell.out"));
                        InputField(exec("cat "+getFilesDir()+"/Bell/JH-Bell.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Bell.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Bell.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Bell")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Bell");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Bell/JH-Bell.out"));
                    InputField(exec("cat "+getFilesDir()+"/Bell/JH-Bell.inp"));
