...
public class Brown2 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Brown2.this, ParmsBrown2.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Brown2.this, CodeBrown2.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Brown2/JH-Brown2.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Brown2/JH-Brown2.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Brown2.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Brown2.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Brown2")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Brown2");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Brown2.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Brown2/JH-Brown2.b "+getFilesDir()+"/Brown2/JH-Brown2.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Brown2/JH-Brown2.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Brown2/JH-Brown2.b");
                    exec("chmod 755 "+getFilesDir()+"/Brown2/JH-Brown2.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Brown2/JH-Brown2.out"));
                        InputField(exec("cat "+getFilesDir()+"/Brown2/JH-Brown2.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Brown2.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Brown2.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Brown2")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Brown2");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Brown2/JH-Brown2.out"));
                    InputField(exec("cat "+getFilesDir()+"/Brown2/JH-Brown2.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Brown2.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
