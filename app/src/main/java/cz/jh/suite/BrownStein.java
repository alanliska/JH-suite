...
public class BrownStein extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BrownStein.this, ParmsBrownStein.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BrownStein.this, CodeBrownStein.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Brown-Stein/JH-Brown-Stein.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Brown-Stein/JH-Brown-Stein.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(BrownStein.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(BrownStein.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Brown-Stein")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Brown-Stein");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(BrownStein.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Brown-Stein/JH-Brown-Stein.b "+getFilesDir()+"/Brown-Stein/JH-Brown-Stein.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Brown-Stein/JH-Brown-Stein.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Brown-Stein/JH-Brown-Stein.b");
                    exec("chmod 755 "+getFilesDir()+"/Brown-Stein/JH-Brown-Stein.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Brown-Stein/JH-Brown-Stein.out"));
                        InputField(exec("cat "+getFilesDir()+"/Brown-Stein/JH-Brown-Stein.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(BrownStein.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(BrownStein.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Brown-Stein")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Brown-Stein");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Brown-Stein/JH-Brown-Stein.out"));
                    InputField(exec("cat "+getFilesDir()+"/Brown-Stein/JH-Brown-Stein.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(BrownStein.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
