...
public class Cabani extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cabani.this, ParmsCabani.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Cabani.this, CodeCabani.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Cabani/JH-Cabani.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Cabani/JH-Cabani.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Cabani.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Cabani.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Cabani")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Cabani");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Cabani.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Cabani/JH-Cabani.b "+getFilesDir()+"/Cabani/JH-Cabani.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Cabani/JH-Cabani.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Cabani/JH-Cabani.b");
                    exec("chmod 755 "+getFilesDir()+"/Cabani/JH-Cabani.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Cabani/JH-Cabani.out"));
                        InputField(exec("cat "+getFilesDir()+"/Cabani/JH-Cabani.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Cabani.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Cabani.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Cabani")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Cabani");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Cabani/JH-Cabani.out"));
                    InputField(exec("cat "+getFilesDir()+"/Cabani/JH-Cabani.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Cabani.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
