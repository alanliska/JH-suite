...
public class Clifford1 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Clifford1.this, ParmsClifford1.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Clifford1.this, CodeClifford1.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Clifford1/JH-Clifford1.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Clifford1/JH-Clifford1.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Clifford1.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Clifford1.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Clifford1")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Clifford1");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Clifford1.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Clifford1/JH-Clifford1.b "+getFilesDir()+"/Clifford1/JH-Clifford1.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Clifford1/JH-Clifford1.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Clifford1/JH-Clifford1.b");
                    exec("chmod 755 "+getFilesDir()+"/Clifford1/JH-Clifford1.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Clifford1/JH-Clifford1.out"));
                        InputField(exec("cat "+getFilesDir()+"/Clifford1/JH-Clifford1.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Clifford1.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Clifford1.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Clifford1")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Clifford1");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Clifford1/JH-Clifford1.out"));
                    InputField(exec("cat "+getFilesDir()+"/Clifford1/JH-Clifford1.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Clifford1.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
