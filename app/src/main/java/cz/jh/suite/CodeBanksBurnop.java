...
public class CodeBanksBurnop extends BanksBurnop {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.codebanksburnop);
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Banks-Burnop.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Banks-Burnop.bas "+getFilesDir()+"/Banks-Burnop");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeBanksBurnop.this, BanksBurnop.class);
