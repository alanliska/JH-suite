...
public class CodeBaylessRicci extends BaylessRicci {
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Bayless-Ricci/JH-Bayless-Ricci.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Bayless-Ricci.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Bayless-Ricci.bas "+getFilesDir()+"/Bayless-Ricci");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeBaylessRicci.this, BaylessRicci.class);
