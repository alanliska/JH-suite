...
public class CodeBrown4 extends Brown4 {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.codebrown4);
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Brown4/JH-Brown4.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Brown4.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Brown4.bas "+getFilesDir()+"/Brown4");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeBrown4.this, Brown4.class);
