...
public class CodeEigenFuoss1 extends EigenFuoss1 {
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Eigen-Fuoss1.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Eigen-Fuoss1.bas "+getFilesDir()+"/Eigen-Fuoss1");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeEigenFuoss1.this, EigenFuoss1.class);
