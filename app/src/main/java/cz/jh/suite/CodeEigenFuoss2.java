...
public class CodeEigenFuoss2 extends EigenFuoss2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.codeeigenfuoss2);
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Eigen-Fuoss2/JH-Eigen-Fuoss2.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Eigen-Fuoss2.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Eigen-Fuoss2.bas "+getFilesDir()+"/Eigen-Fuoss2");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeEigenFuoss2.this, EigenFuoss2.class);
