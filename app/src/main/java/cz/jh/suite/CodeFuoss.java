...
public class CodeFuoss extends Fuoss {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.codefuoss);
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Fuoss/JH-Fuoss.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Fuoss.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Fuoss.bas "+getFilesDir()+"/Fuoss");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeFuoss.this, Fuoss.class);
