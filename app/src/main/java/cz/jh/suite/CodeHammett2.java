...
public class CodeHammett2 extends Hammett2 {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.codehammett2);
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Hammett2/JH-Hammett2.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Hammett2.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Hammett2.bas "+getFilesDir()+"/Hammett2");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeHammett2.this, Hammett2.class);
