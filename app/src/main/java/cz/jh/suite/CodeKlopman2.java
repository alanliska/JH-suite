...
public class CodeKlopman2 extends Klopman2 {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.codeklopman2);
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Klopman2/JH-Klopman2.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Klopman2.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Klopman2.bas "+getFilesDir()+"/Klopman2");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeKlopman2.this, Klopman2.class);
