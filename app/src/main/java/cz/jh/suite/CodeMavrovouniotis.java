...
public class CodeMavrovouniotis extends Mavrovouniotis {
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Mavrovouniotis.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Mavrovouniotis.bas "+getFilesDir()+"/Mavrovouniotis");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeMavrovouniotis.this, Mavrovouniotis.class);
