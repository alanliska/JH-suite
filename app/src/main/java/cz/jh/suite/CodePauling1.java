...
public class CodePauling1 extends Pauling1 {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.codepauling1);
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Pauling1/JH-Pauling1.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Pauling1.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Pauling1.bas "+getFilesDir()+"/Pauling1");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodePauling1.this, Pauling1.class);
