...
public class CodeRicci extends Ricci {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.codericci);
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Ricci/JH-Ricci.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Ricci.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Ricci.bas "+getFilesDir()+"/Ricci");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeRicci.this, Ricci.class);
