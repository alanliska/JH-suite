...
public class CodeSimamora extends Simamora {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.codesimamora);
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Simamora/JH-Simamora.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Simamora.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Simamora.bas "+getFilesDir()+"/Simamora");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeSimamora.this, Simamora.class);
