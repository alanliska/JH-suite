...
public class CodeZuman1 extends Zuman1 {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.codezuman1);
    ...
    {
        super.onStart();
        Display(exec("cat "+getFilesDir()+"/Zuman1/JH-Zuman1.bas"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Zuman1.bas", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Zuman1.bas "+getFilesDir()+"/Zuman1");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(CodeZuman1.this, Zuman1.class);
