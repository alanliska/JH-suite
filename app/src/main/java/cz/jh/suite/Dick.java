...
public class Dick extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Dick.this, ParmsDick.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Dick.this, CodeDick.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Dick/JH-Dick.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Dick/JH-Dick.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Dick.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Dick.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Dick")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Dick");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Dick.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Dick/JH-Dick.b "+getFilesDir()+"/Dick/JH-Dick.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Dick/JH-Dick.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Dick/JH-Dick.b");
                    exec("chmod 755 "+getFilesDir()+"/Dick/JH-Dick.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Dick/JH-Dick.out"));
                        InputField(exec("cat "+getFilesDir()+"/Dick/JH-Dick.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Dick.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Dick.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Dick")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Dick");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Dick/JH-Dick.out"));
                    InputField(exec("cat "+getFilesDir()+"/Dick/JH-Dick.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Dick.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
