...
public class Edwards2 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Edwards2.this, ParmsEdwards2.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Edwards2.this, CodeEdwards2.class);
                startActivity(intent);
            }
        });
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Edwards2.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Edwards2.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Edwards2")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Edwards2");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Edwards2.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Edwards2/JH-Edwards2.b "+getFilesDir()+"/Edwards2/JH-Edwards2.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Edwards2/JH-Edwards2.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Edwards2/JH-Edwards2.b");
                    exec("chmod 755 "+getFilesDir()+"/Edwards2/JH-Edwards2.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Edwards2/JH-Edwards2.out"));
                        InputField(exec("cat "+getFilesDir()+"/Edwards2/JH-Edwards2.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Edwards2.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Edwards2.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Edwards2")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Edwards2");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Edwards2/JH-Edwards2.out"));
                    InputField(exec("cat "+getFilesDir()+"/Edwards2/JH-Edwards2.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Edwards2.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
