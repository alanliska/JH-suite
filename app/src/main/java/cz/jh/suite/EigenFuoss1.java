...
public class EigenFuoss1 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EigenFuoss1.this, ParmsEigenFuoss1.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EigenFuoss1.this, CodeEigenFuoss1.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(EigenFuoss1.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(EigenFuoss1.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Eigen-Fuoss1")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Eigen-Fuoss1");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(EigenFuoss1.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.b "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.b");
                    exec("chmod 755 "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.out"));
                        InputField(exec("cat "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(EigenFuoss1.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(EigenFuoss1.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Eigen-Fuoss1")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Eigen-Fuoss1");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.out"));
                    InputField(exec("cat "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(EigenFuoss1.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
