...
public class Hammett1 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hammett1);
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Hammett1.this, ParmsHammett1.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Hammett1.this, CodeHammett1.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Hammett1/JH-Hammett1.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Hammett1/JH-Hammett1.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Hammett1.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Hammett1.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Hammett1")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Hammett1");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Hammett1.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Hammett1/JH-Hammett1.b "+getFilesDir()+"/Hammett1/JH-Hammett1.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Hammett1/JH-Hammett1.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Hammett1/JH-Hammett1.b");
                    exec("chmod 755 "+getFilesDir()+"/Hammett1/JH-Hammett1.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Hammett1/JH-Hammett1.out"));
                        InputField(exec("cat "+getFilesDir()+"/Hammett1/JH-Hammett1.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Hammett1.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Hammett1.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Hammett1")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Hammett1");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Hammett1/JH-Hammett1.out"));
                    InputField(exec("cat "+getFilesDir()+"/Hammett1/JH-Hammett1.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Hammett1.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
