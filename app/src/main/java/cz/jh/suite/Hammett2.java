...
public class Hammett2 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hammett2);
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Hammett2.this, ParmsHammett2.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Hammett2.this, CodeHammett2.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Hammett2/JH-Hammett2.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Hammett2/JH-Hammett2.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Hammett2.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Hammett2.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Hammett2")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Hammett2");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Hammett2.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Hammett2/JH-Hammett2.b "+getFilesDir()+"/Hammett2/JH-Hammett2.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Hammett2/JH-Hammett2.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Hammett2/JH-Hammett2.b");
                    exec("chmod 755 "+getFilesDir()+"/Hammett2/JH-Hammett2.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Hammett2/JH-Hammett2.out"));
                        InputField(exec("cat "+getFilesDir()+"/Hammett2/JH-Hammett2.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Hammett2.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Hammett2.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Hammett2")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Hammett2");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Hammett2/JH-Hammett2.out"));
                    InputField(exec("cat "+getFilesDir()+"/Hammett2/JH-Hammett2.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Hammett2.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
