...
public class Hancock2 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hancock2);
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Hancock2.this, ParmsHancock2.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Hancock2.this, CodeHancock2.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Hancock2/JH-Hancock2.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Hancock2/JH-Hancock2.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Hancock2.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Hancock2.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Hancock2")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Hancock2");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Hancock2.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Hancock2/JH-Hancock2.b "+getFilesDir()+"/Hancock2/JH-Hancock2.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Hancock2/JH-Hancock2.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Hancock2/JH-Hancock2.b");
                    exec("chmod 755 "+getFilesDir()+"/Hancock2/JH-Hancock2.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Hancock2/JH-Hancock2.out"));
                        InputField(exec("cat "+getFilesDir()+"/Hancock2/JH-Hancock2.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Hancock2.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Hancock2.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Hancock2")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Hancock2");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Hancock2/JH-Hancock2.out"));
                    InputField(exec("cat "+getFilesDir()+"/Hancock2/JH-Hancock2.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Hancock2.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
