...
public class Jankowski extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Jankowski.this, ParmsJankowski.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Jankowski.this, CodeJankowski.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Jankowski/JH-Jankowski.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Jankowski/JH-Jankowski.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Jankowski.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Jankowski.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Jankowski")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Jankowski");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Jankowski.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Jankowski/JH-Jankowski.b "+getFilesDir()+"/Jankowski/JH-Jankowski.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Jankowski/JH-Jankowski.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Jankowski/JH-Jankowski.b");
                    exec("chmod 755 "+getFilesDir()+"/Jankowski/JH-Jankowski.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Jankowski/JH-Jankowski.out"));
                        InputField(exec("cat "+getFilesDir()+"/Jankowski/JH-Jankowski.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Jankowski.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Jankowski.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Jankowski")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Jankowski");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Jankowski/JH-Jankowski.out"));
                    InputField(exec("cat "+getFilesDir()+"/Jankowski/JH-Jankowski.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Jankowski.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
