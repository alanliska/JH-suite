...
public class Klopman2 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.klopman2);
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Klopman2.this, ParmsKlopman2.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Klopman2.this, CodeKlopman2.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Klopman2/JH-Klopman2.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Klopman2/JH-Klopman2.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Klopman2.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Klopman2.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Klopman2")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Klopman2");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Klopman2.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Klopman2/JH-Klopman2.b "+getFilesDir()+"/Klopman2/JH-Klopman2.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Klopman2/JH-Klopman2.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Klopman2/JH-Klopman2.b");
                    exec("chmod 755 "+getFilesDir()+"/Klopman2/JH-Klopman2.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Klopman2/JH-Klopman2.out"));
                        InputField(exec("cat "+getFilesDir()+"/Klopman2/JH-Klopman2.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Klopman2.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Klopman2.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Klopman2")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Klopman2");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Klopman2/JH-Klopman2.out"));
                    InputField(exec("cat "+getFilesDir()+"/Klopman2/JH-Klopman2.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Klopman2.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
