...
public class Mavrovouniotis extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Mavrovouniotis.this, ParmsMavrovouniotis.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Mavrovouniotis.this, CodeMavrovouniotis.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Mavrovouniotis.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Mavrovouniotis.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Mavrovouniotis")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Mavrovouniotis");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Mavrovouniotis.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.b "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.b");
                    exec("chmod 755 "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.out"));
                        InputField(exec("cat "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Mavrovouniotis.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Mavrovouniotis.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Mavrovouniotis")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Mavrovouniotis");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.out"));
                    InputField(exec("cat "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Mavrovouniotis.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
