...
public class PCM extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PCM.this, ParmsPCM.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PCM.this, CodePCM.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/PCM/JH-PCM.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/PCM/JH-PCM.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(PCM.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(PCM.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/PCM")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/PCM");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(PCM.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/PCM/JH-PCM.b "+getFilesDir()+"/PCM/JH-PCM.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/PCM/JH-PCM.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/PCM/JH-PCM.b");
                    exec("chmod 755 "+getFilesDir()+"/PCM/JH-PCM.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/PCM/JH-PCM.out"));
                        InputField(exec("cat "+getFilesDir()+"/PCM/JH-PCM.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(PCM.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(PCM.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/PCM")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/PCM");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/PCM/JH-PCM.out"));
                    InputField(exec("cat "+getFilesDir()+"/PCM/JH-PCM.inp"));
