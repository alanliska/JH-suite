...
public class ParmsBanksBurnop extends BanksBurnop {
    ...
    {
        super.onStart();
        ParDisplay(exec("cat "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.par"));
        DatDisplay(exec("cat "+getFilesDir()+"/Banks-Burnop/JH-Banks-Burnop.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Banks-Burnop.par", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(ParFile);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Banks-Burnop.par "+getFilesDir()+"/Banks-Burnop");

                String DatFile = DatContent.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout20 = openFileOutput("JH-Banks-Burnop.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout20);
                    outputWriter.write(DatFile);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Banks-Burnop.dat "+getFilesDir()+"/Banks-Burnop");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsBanksBurnop.this, BanksBurnop.class);
