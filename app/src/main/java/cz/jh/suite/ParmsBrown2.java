...
public class ParmsBrown2 extends Brown2 {
    ...
    {
        super.onStart();
        Par1Display(exec("cat "+getFilesDir()+"/Brown2/JH-Brown2.par"));
        Par2Display(exec("cat "+getFilesDir()+"/Brown2/JH-Klopman.par"));
        Par3Display(exec("cat "+getFilesDir()+"/Brown2/JH-Parr.par"));
        Dat1Display(exec("cat "+getFilesDir()+"/Brown2/JH-Acids_Brown2.dat"));
        Dat2Display(exec("cat "+getFilesDir()+"/Brown2/JH-Acids_Parr.dat"));
        Dat3Display(exec("cat "+getFilesDir()+"/Brown2/JH-AtomData_Brown2.dat"));
        Dat4Display(exec("cat "+getFilesDir()+"/Brown2/JH-Bases_Brown2.dat"));
        Dat7Display(exec("cat "+getFilesDir()+"/Brown2/JH-Radii_Shannon.dat"));
        Dat8Display(exec("cat "+getFilesDir()+"/Brown2/JH-Radii_Stockar.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Brown2.par", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(Par1File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Brown2.par "+getFilesDir()+"/Brown2");
                ...
                exec("mv "+getFilesDir()+"/JH-Klopman.par "+getFilesDir()+"/Brown2");
                ...
                exec("mv "+getFilesDir()+"/JH-Parr.par "+getFilesDir()+"/Brown2");

                String Dat1File = Dat1Content.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout40 = openFileOutput("JH-Acids_Brown2.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout40);
                    outputWriter.write(Dat1File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Acids_Brown2.dat "+getFilesDir()+"/Brown2");
                ...
                exec("mv "+getFilesDir()+"/JH-Acids_Parr.dat "+getFilesDir()+"/Brown2");

                String Dat3File = Dat3Content.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout60 = openFileOutput("JH-AtomData_Brown2.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout60);
                    outputWriter.write(Dat3File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-AtomData_Brown2.dat "+getFilesDir()+"/Brown2");

                String Dat4File = Dat4Content.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout70 = openFileOutput("JH-Bases_Brown2.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout70);
                    outputWriter.write(Dat4File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Bases_Brown2.dat "+getFilesDir()+"/Brown2");
                ...
                exec("mv "+getFilesDir()+"/JH-Radii_Shannon.dat "+getFilesDir()+"/Brown2");
                ...
                exec("mv "+getFilesDir()+"/JH-Radii_Stockar.dat "+getFilesDir()+"/Brown2");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsBrown2.this, Brown2.class);
