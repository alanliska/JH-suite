...
public class ParmsEdwards1 extends Edwards1 {
    ...
    {
        super.onStart();
        Dat1Display(exec("cat "+getFilesDir()+"/Edwards1/Acids_JH-Edwards1.dat"));
        Dat2Display(exec("cat "+getFilesDir()+"/Edwards1/Bases_JH-Edwards1.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("Acids_JH-Edwards1.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(Dat1File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Acids_JH-Edwards1.dat "+getFilesDir()+"/Edwards1");

                String Dat2File = Dat2Content.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout20 = openFileOutput("Bases_JH-Edwards1.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout20);
                    outputWriter.write(Dat2File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Bases_JH-Edwards1.dat "+getFilesDir()+"/Edwards1");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsEdwards1.this, Edwards1.class);
