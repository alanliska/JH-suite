...
public class ParmsEdwards2 extends Edwards2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parmsedwards2);
    ...
    {
        super.onStart();
        Dat1Display(exec("cat "+getFilesDir()+"/Edwards2/Complexes_JH-Edwards2.dat"));
        Dat2Display(exec("cat "+getFilesDir()+"/Edwards2/Nucleophiles_JH-Edwards2.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("Complexes_JH-Edwards2.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(Dat1File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Complexes_JH-Edwards2.dat "+getFilesDir()+"/Edwards2");

                String Dat2File = Dat2Content.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout20 = openFileOutput("Nucleophiles_JH-Edwards2.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout20);
                    outputWriter.write(Dat2File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Nucleophiles_JH-Edwards2.dat "+getFilesDir()+"/Edwards2");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsEdwards2.this, Edwards2.class);
