...
public class ParmsEigenFuoss1 extends EigenFuoss1 {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.parmseigenfuoss1);
    ...
    {
        super.onStart();
        ParDisplay(exec("cat "+getFilesDir()+"/Eigen-Fuoss1/JH-Eigen-Fuoss1.par"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Eigen-Fuoss1.par", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(ParFile);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Eigen-Fuoss1.par "+getFilesDir()+"/Eigen-Fuoss1");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsEigenFuoss1.this, EigenFuoss1.class);
