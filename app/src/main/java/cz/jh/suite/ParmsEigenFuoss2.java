...
public class ParmsEigenFuoss2 extends EigenFuoss2 {
    ...
    {
        super.onStart();
        ParDisplay(exec("cat "+getFilesDir()+"/Eigen-Fuoss2/JH-Eigen-Fuoss2.par"));
        DatDisplay(exec("cat "+getFilesDir()+"/Eigen-Fuoss2/JH-Eigen-Fuoss2.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Eigen-Fuoss2.par", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(ParFile);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Eigen-Fuoss2.par "+getFilesDir()+"/Eigen-Fuoss2");

                String DatFile = DatContent.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout20 = openFileOutput("JH-Eigen-Fuoss2.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout20);
                    outputWriter.write(DatFile);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Eigen-Fuoss2.dat "+getFilesDir()+"/Eigen-Fuoss2");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsEigenFuoss2.this, EigenFuoss2.class);
