...
public class ParmsHancock2 extends Hancock2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parmshancock2);
    ...
    {
        super.onStart();
        Dat1Display(exec("cat "+getFilesDir()+"/Hancock2/Acids_JH-Hancock2.dat"));
        Dat2Display(exec("cat "+getFilesDir()+"/Hancock2/Bases_JH-Hancock2.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("Acids_JH-Hancock2.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(Dat1File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Acids_JH-Hancock2.dat "+getFilesDir()+"/Hancock2");

                String Dat2File = Dat2Content.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout20 = openFileOutput("Bases_JH-Hancock2.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout20);
                    outputWriter.write(Dat2File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Bases_JH-Hancock2.dat "+getFilesDir()+"/Hancock2");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsHancock2.this, Hancock2.class);
