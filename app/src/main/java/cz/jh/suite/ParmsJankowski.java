...
public class ParmsJankowski extends Jankowski {
    ...
    {
        super.onStart();
        DatDisplay(exec("cat "+getFilesDir()+"/Jankowski/JH-Jankowski.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout20 = openFileOutput("JH-Jankowski.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout20);
                    outputWriter.write(DatFile);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Jankowski.dat "+getFilesDir()+"/Jankowski");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsJankowski.this, Jankowski.class);
