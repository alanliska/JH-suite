...
public class ParmsMavrovouniotis extends Mavrovouniotis {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parmsmavrovouniotis);
    ...
    {
        super.onStart();
        DatDisplay(exec("cat "+getFilesDir()+"/Mavrovouniotis/JH-Mavrovouniotis.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout20 = openFileOutput("JH-Mavrovouniotis.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout20);
                    outputWriter.write(DatFile);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Mavrovouniotis.dat "+getFilesDir()+"/Mavrovouniotis");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsMavrovouniotis.this, Mavrovouniotis.class);
