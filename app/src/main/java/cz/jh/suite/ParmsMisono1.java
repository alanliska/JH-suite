...
public class ParmsMisono1 extends Misono1 {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.parmsmisono1);
    ...
    {
        super.onStart();
        Dat1Display(exec("cat "+getFilesDir()+"/Misono1/JH-Misono1.dat"));
        Dat2Display(exec("cat "+getFilesDir()+"/Misono1/JH-AtomData_Misono1.dat"));
        Dat3Display(exec("cat "+getFilesDir()+"/Misono1/JH-Electronegativity_Misono1.dat"));
        Dat4Display(exec("cat "+getFilesDir()+"/Misono1/JH-Radii_Stockar.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Misono1.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(Dat1File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Misono1.dat "+getFilesDir()+"/Misono1");

                String Dat2File = Dat2Content.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout20 = openFileOutput("JH-AtomData_Misono1.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout20);
                    outputWriter.write(Dat2File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-AtomData_Misono1.dat "+getFilesDir()+"/Misono1");

                String Dat3File = Dat3Content.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout30 = openFileOutput("JH-Electronegativity_Misono1.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout30);
                    outputWriter.write(Dat3File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Electronegativity_Misono1.dat "+getFilesDir()+"/Misono1");
                ...
                exec("mv "+getFilesDir()+"/JH-Radii_Stockar.dat "+getFilesDir()+"/Misono1");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsMisono1.this, Misono1.class);
