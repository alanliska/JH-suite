...
public class ParmsPCM extends PCM {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.parmspcm);
    ...
    {
        super.onStart();
        DatDisplay(exec("cat "+getFilesDir()+"/PCM/JH-PCM.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout20 = openFileOutput("JH-PCM.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout20);
                    outputWriter.write(DatFile);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-PCM.dat "+getFilesDir()+"/PCM");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsPCM.this, PCM.class);
