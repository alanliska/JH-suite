...
public class ParmsPauling2 extends Pauling2 {
	...
	getSupportActionBar().hide();
        setContentView(R.layout.parmspauling2);
    ...
    {
        super.onStart();
        ParDisplay(exec("cat "+getFilesDir()+"/Pauling2/JH-Pauling2.par"));
        DatDisplay(exec("cat "+getFilesDir()+"/Pauling2/JH-Pauling2.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("JH-Pauling2.par", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(ParFile);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Pauling2.par "+getFilesDir()+"/Pauling2");

                String DatFile = DatContent.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout20 = openFileOutput("JH-Pauling2.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout20);
                    outputWriter.write(DatFile);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/JH-Pauling2.dat "+getFilesDir()+"/Pauling2");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsPauling2.this, Pauling2.class);
