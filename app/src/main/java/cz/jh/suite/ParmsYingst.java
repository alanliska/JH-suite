...
public class ParmsYingst extends Yingst {
    ...
    {
        super.onStart();
        Dat1Display(exec("cat "+getFilesDir()+"/Yingst/Acids_JH-Yingst.dat"));
        Dat2Display(exec("cat "+getFilesDir()+"/Yingst/Bases_JH-Yingst.dat"));
    }
    ...
    private View.OnClickListener saveFileClick; {
        saveFileClick = new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    FileOutputStream fileout10 = openFileOutput("Acids_JH-Yingst.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout10);
                    outputWriter.write(Dat1File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Acids_JH-Yingst.dat "+getFilesDir()+"/Yingst");

                String Dat2File = Dat2Content.getText().toString();
                // TODO Auto-generated method stub //
                try {
                    FileOutputStream fileout20 = openFileOutput("Bases_JH-Yingst.dat", MODE_PRIVATE);
                    OutputStreamWriter outputWriter = new OutputStreamWriter(fileout20);
                    outputWriter.write(Dat2File);
                    outputWriter.close();
                } catch (Exception e) {
                }
                exec("mv "+getFilesDir()+"/Bases_JH-Yingst.dat "+getFilesDir()+"/Yingst");
            }
        };
    }
    ...
    private View.OnClickListener QuitClick; {
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(ParmsYingst.this, Yingst.class);
