...
public class Ricci extends MainActivity {
	...
	getSupportActionBar().hide();
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Ricci.this, ParmsRicci.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Ricci.this, CodeRicci.class);
                startActivity(intent);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Ricci/JH-Ricci.inp");
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Ricci.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Ricci/JH-Ricci.b "+getFilesDir()+"/Ricci/JH-Ricci.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Ricci/JH-Ricci.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Ricci/JH-Ricci.b");
                    exec("chmod 755 "+getFilesDir()+"/Ricci/JH-Ricci.out");
                    try {
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Ricci/JH-Ricci.out"));
                    InputField(exec("cat "+getFilesDir()+"/Ricci/JH-Ricci.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Ricci.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
