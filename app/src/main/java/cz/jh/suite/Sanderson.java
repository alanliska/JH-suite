...
public class Sanderson extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sanderson);
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Sanderson.this, ParmsSanderson.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Sanderson.this, CodeSanderson.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Sanderson/JH-Sanderson.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Sanderson/JH-Sanderson.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Sanderson.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Sanderson.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Sanderson")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Sanderson");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Sanderson.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Sanderson/JH-Sanderson.b "+getFilesDir()+"/Sanderson/JH-Sanderson.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Sanderson/JH-Sanderson.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Sanderson/JH-Sanderson.b");
                    exec("chmod 755 "+getFilesDir()+"/Sanderson/JH-Sanderson.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Sanderson/JH-Sanderson.out"));
                        InputField(exec("cat "+getFilesDir()+"/Sanderson/JH-Sanderson.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Sanderson.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Sanderson.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Sanderson")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Sanderson");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Sanderson/JH-Sanderson.out"));
                    InputField(exec("cat "+getFilesDir()+"/Sanderson/JH-Sanderson.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Sanderson.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
