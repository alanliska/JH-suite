...
public class Simamora extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.simamora);
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Simamora.this, ParmsSimamora.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Simamora.this, CodeSimamora.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Simamora/JH-Simamora.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Simamora/JH-Simamora.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Simamora.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Simamora.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Simamora")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Simamora");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Simamora.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Simamora/JH-Simamora.b "+getFilesDir()+"/Simamora/JH-Simamora.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Simamora/JH-Simamora.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Simamora/JH-Simamora.b");
                    exec("chmod 755 "+getFilesDir()+"/Simamora/JH-Simamora.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Simamora/JH-Simamora.out"));
                        InputField(exec("cat "+getFilesDir()+"/Simamora/JH-Simamora.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Simamora.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Simamora.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Simamora")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Simamora");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Simamora/JH-Simamora.out"));
                    InputField(exec("cat "+getFilesDir()+"/Simamora/JH-Simamora.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Simamora.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
