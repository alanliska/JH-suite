...
public class Yamada extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yamada);
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Yamada.this, ParmsYamada.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Yamada.this, CodeYamada.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Yamada/JH-Yamada.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Yamada/JH-Yamada.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Yamada.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Yamada.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Yamada")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Yamada");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Yamada.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Yamada/JH-Yamada.b "+getFilesDir()+"/Yamada/JH-Yamada.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Yamada/JH-Yamada.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Yamada/JH-Yamada.b");
                    exec("chmod 755 "+getFilesDir()+"/Yamada/JH-Yamada.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Yamada/JH-Yamada.out"));
                        InputField(exec("cat "+getFilesDir()+"/Yamada/JH-Yamada.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Yamada.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Yamada.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Yamada")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Yamada");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Yamada/JH-Yamada.out"));
                    InputField(exec("cat "+getFilesDir()+"/Yamada/JH-Yamada.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Yamada.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
