...
public class Yingst extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yingst);
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Yingst.this, ParmsYingst.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Yingst.this, CodeYingst.class);
                startActivity(intent);
            }
        });
    }
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Yingst/JH-Yingst.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Yingst/JH-Yingst.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Yingst.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Yingst.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Yingst")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Yingst");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Yingst.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Yingst/JH-Yingst.b "+getFilesDir()+"/Yingst/JH-Yingst.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Yingst/JH-Yingst.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Yingst/JH-Yingst.b");
                    exec("chmod 755 "+getFilesDir()+"/Yingst/JH-Yingst.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Yingst/JH-Yingst.out"));
                        InputField(exec("cat "+getFilesDir()+"/Yingst/JH-Yingst.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Yingst.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Yingst.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Yingst")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Yingst");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Yingst/JH-Yingst.out"));
                    InputField(exec("cat "+getFilesDir()+"/Yingst/JH-Yingst.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Yingst.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
