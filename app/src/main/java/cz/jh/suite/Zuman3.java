...
public class Zuman3 extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zuman3);
        ...
        Parameters.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Zuman3.this, ParmsZuman3.class);
        ...
        Code.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Zuman3.this, CodeZuman3.class);
                startActivity(intent);
            }
        });
    ...
    {
        super.onStart();
        InputField(exec("cat "+getFilesDir()+"/Zuman3/JH-Zuman3.inp"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == READ_FILE && data != null) {
            ...
            try {
                ...
                exec("cp "+getFilesDir()+"/Input.txt "+getFilesDir()+"/Zuman3/JH-Zuman3.inp");
    ...
    public void alertSaveInput(){
        ...
        EditText editText = new EditText(Zuman3.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Zuman3.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Zuman3")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveInputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Zuman3");
                    }
                })
    ...
    private void openprogressdialog() {
        // TODO Auto-generated method stub //
        progressDialog = new ProgressDialog(Zuman3.this);
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbbc.so -o "+getFilesDir()+"/Zuman3/JH-Zuman3.b "+getFilesDir()+"/Zuman3/JH-Zuman3.bas");
                    exec("chmod -R 755 "+getFilesDir()+"/Zuman3/JH-Zuman3.b");
                    exec(getApplicationInfo().nativeLibraryDir+"/libxbvm.so "+getFilesDir()+"/Zuman3/JH-Zuman3.b");
                    exec("chmod 755 "+getFilesDir()+"/Zuman3/JH-Zuman3.out");
                    try {
                        OutputField(exec("cat "+getFilesDir()+"/Zuman3/JH-Zuman3.out"));
                        InputField(exec("cat "+getFilesDir()+"/Zuman3/JH-Zuman3.inp"));
    ...
    public void alertSaveOutput(){
        // creating the EditText widget programatically
        EditText editText15 = new EditText(Zuman3.this);
        // create the AlertDialog as final
        final AlertDialog dialog = new AlertDialog.Builder(Zuman3.this)
                .setMessage("The file will be saved in the folder /storage/emulated/0/Documents/jh-suite/work/Zuman3")
                .setTitle("Please write the desired filename (if already present, it will be overwritten)")
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        exec("mv "+getFilesDir()+"/"+SaveOutputName+" "+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+"/jh-suite/work/Zuman3");
                    }
                })
...
//                String Inputfile = outputView2.getText().toString();
                try {
                    OutputFieldHighlighted(exec("cat "+getFilesDir()+"/Zuman3/JH-Zuman3.out"));
                    InputField(exec("cat "+getFilesDir()+"/Zuman3/JH-Zuman3.inp"));
...
//                        outputView4.setText(strX);
    ...
    private View.OnClickListener QuitClick; {
        ...
        QuitClick = new View.OnClickListener() {
            public void onClick(View v) {
                // TODO Auto-generated method stub //
                Intent intent = new Intent(Zuman3.this, MainActivity.class);
                startActivity(intent);
            }
        };
    }
